		...
		'<nav>' +
			'<ul class="pagination justify-content-end">' +
				...
				'<template v-for="dispP in pageRange">' + 
					//'<li v-if="(dispP == p)" class="page-item active" @click="clickPageItem(dispP)"><a class="page-link" href="javascript:void(0)">{{ dispP }}</a></li>' +
					//'<li v-else class="page-item" @click="clickPageItem(dispP)"><a class="page-link" href="javascript:void(0)">{{ dispP }}</a></li>' +
